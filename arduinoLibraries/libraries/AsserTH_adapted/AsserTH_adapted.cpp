...
//constructeur
AsserTH_adapted::AsserTH_adapted( float arg_Kp, float arg_Ki, float arg_Kd,  float arg_Tdesired, float arg_Hdesired) :
...
uint8_t AsserTH_adapted::THcontrol(uint8_t RalwaysOn_BrumOff){
