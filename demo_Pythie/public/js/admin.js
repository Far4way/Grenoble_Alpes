...
$(function () {
    ...
    $('#inputExperienceNumber').val(expId + 1);
    ...
    $('.consoleInput').on('submit', function (e) {
        ...
        let data = username + "_::> " + $(".consoleInput input").val();
    ...
    $('.experienceForm #firstStep').on('submit', function (e) {
        ...
        $('#experienceName').html(name);
        $('#experienceEndDate').html(endDate);
        $('#experienceStartDate').html(startTime);
        $('#experienceNumber').html(number);
        $('#experienceUser').html(username);

        expId = parseInt(number);
        stepId = 1;
    ...
    $('#addProductToGroup').on('click', function () {
        ...
        $('li.' + groupSelection.val() + ' ul').append("<li>" + inputProductVolume.val() + " of " + inputProductName.val() + " at " + inputProductConcentration.val() + "</li>");
    ...
    function addWellGroupToList(groupName) {
        ...
        let lengthWell = selectedWell.length;
        let base = "<li class='" + groupName + "'> <div> <span>" + groupName + " : " + lengthWell + " Wells </span> <div><ul></ul></div> </div> </li>";
        let list = $('#listGroups');
        indexGroup = 0;
        groupUsed.some(function (element, index) {
            if (element === false) {
